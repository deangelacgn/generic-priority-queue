...
class PQ
{
     ...
     public:
         ...
         {
             std::cout << "BH: [ ";
             std::copy( m_data.get(), m_data.get()+m_length, std::ostream_iterator<ValueType>(std::cout, " ") );
             std::cout << "| ";
             std::copy( m_data.get()+m_length, m_data.get()+m_capacity, std::ostream_iterator<ValueType>(std::cout, " ") );
             std::cout << "],";
